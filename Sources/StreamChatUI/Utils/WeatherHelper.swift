...
public class WeatherHelper {
    ...
    // Cold Messages
    public static var coldWeatherMessages = ["Colder than your dating streak",
                     "This air hurts my face"]
    // Hot Messages
    public static var hotWeatherMessages = ["Hot as hell",
                    "Hot as fcuk",
                    "Better shave your legs. It’s shorts weather",
                    "Sunblock. Sneakers. T-Shirt",
                    "Are we inside a fucking oven?"]
    // SunnyDay Messages
    public static var sunnyDayMessages = ["It’s going to be effing perfect",
                      "Sunblock. Sneakers. T-Shirt",
    ...
    public static var sunnyNightMessages = ["It’s going to be effing perfect"]
    // CloudyDay Messages
    public static var cloudyDayMessages = ["It’s cloudy. Like Snoop Dogg’s general existence",
                      "It’s meh, but it ain’t no double rainbow",
                      "It’s going to be effing perfect better"]
    // Cloudy night Messages
    public static var cloudyNightMessages = ["It’s cloudy. Like Snoop Dogg’s general existence"]
    // Snow Messages
    public static var snowMessages = ["Don’t eat the yellow snow"]
    // Windy Messages
    public static var windyMessages = ["Slow farts by mother naturE"]
    // Rainy day Messages
    public static var rainyDayMessages = ["There would never be rainbows without the rain …",
    "When life throws you a rainy day, play in the puddles",
    "Keep calm and dance in the rain",
    "Some people feel the rain. Others just get wet",
    "Rain is just confetti from the sky"]
    // Rainy night Messages
    public static var rainyNightMessages = ["Sleep is so much easier when it rains...",
    "Best thing one can do when it's raining is to let it rain",
    "I love falling asleep to the sound of rain",
    "Enjoy relaxing rain ASMR compliment of nature",
    "Rain is just confetti from the sky"]
    // Tornado Messages
    public static var tornadoMessages = ["Tornado! Take cover, Dorothy.",
    "Abandon all hope ye who venture out into this weather"]

    // Temperature Formatter
    public static var temperatureDisplayTextFormatter: NumberFormatter {
    ...
    public static var temperatureValueFormatter: MeasurementFormatter {
    ...
    public static func getWeatherDetail(condition: String, tempInFahrenheit: Double = 0.0) -> WeatherDetailModel {
